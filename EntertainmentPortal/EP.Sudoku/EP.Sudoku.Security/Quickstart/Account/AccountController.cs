...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    else
                    {
                        ...
                        await emailService.SendEmailAsync(model.Email, "Confirm your account in SudokuApp",
                            $"To activate your account follow the link: <a href='{callbackUrl}'>Click me!</a>");
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            return View("Redirect", new RedirectViewModel { RedirectUrl = vm.PostLogoutRedirectUri });
        }
