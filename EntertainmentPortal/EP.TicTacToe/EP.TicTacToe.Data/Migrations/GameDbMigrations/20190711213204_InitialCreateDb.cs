    ...
    public partial class InitialCreateDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_Haunters", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    HaunterId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FirstPlayers", x => x.Id);
                    table.ForeignKey(
                        "FK_FirstPlayers_Haunters_HaunterId",
                        x => x.HaunterId,
                        "Haunters",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecondPlayers", x => x.Id);
                    table.ForeignKey(
                        "FK_SecondPlayers_Haunters_HaunterId",
                        x => x.HaunterId,
                        "Haunters",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    SecondPlayerId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Players", x => x.Id);
                    table.ForeignKey(
                        "FK_Players_FirstPlayers_FirstPlayerId",
                        x => x.FirstPlayerId,
                        "FirstPlayers",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        "FK_Players_SecondPlayers_SecondPlayerId",
                        x => x.SecondPlayerId,
                        "SecondPlayers",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
