...
namespace EP.TicTacToe.Security.Quickstart.Account
{
    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            ProcessLoginCallbackForSaml2p(result, additionalLocalClaims,
                localSignInProps);
            ...
            await _events.RaiseAsync(
                new UserLoginSuccessEvent(provider, providerUserId, user.Id, name));
        ...
        private async Task<IActionResult> ProcessWindowsLoginAsync(string returnUrl)
        {
            ...
            var result =
                await HttpContext.AuthenticateAsync(AccountOptions
            ...
            if (result?.Principal is WindowsPrincipal wp)
            {
                ...
                if (AccountOptions.IncludeWindowsGroups)
                {
                    ...
                    var roles =
                        groups.Select(x => new Claim(JwtClaimTypes.Role, x.Value));
                    id.AddClaims(roles);
                }
        ...
        private async Task<(ApplicationUser user, string provider, string providerUserId,
                                                     ...
                                                     localSignInProps)
        {
            ...
            var sid =
                externalResult.Principal.Claims.FirstOrDefault(x =>
            ...
            if (id_token != null)
                localSignInProps.StoreTokens(new[]
                    {new AuthenticationToken {Name = "id_token", Value = id_token}});
        }
