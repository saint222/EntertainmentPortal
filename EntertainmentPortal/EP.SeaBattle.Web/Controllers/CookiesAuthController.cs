...
namespace EP.SeaBattle.Web.Controllers
{
    ...
    public class CookiesAuthController : ControllerBase
    {
        ...
        [HttpPost("register")]
        public async Task<IActionResult> RegisterWithCookies([FromBody] AuthData userAuthData)
        {
        ...
        [HttpPost("login")]
        public async Task<IActionResult> LoginWithCookies([FromBody] AuthData userAuthData)
        {
