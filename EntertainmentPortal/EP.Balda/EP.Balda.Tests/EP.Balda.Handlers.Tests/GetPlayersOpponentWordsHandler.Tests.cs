...
{
    [TestFixture]
    public class GetPlayersOpponentWordsHandler_Tests
    {
        [Test]
        public async Task GetPlayersOpponentWordsHandler_Handle_NormalData_RightOrder()
        {
            var options = new DbContextOptionsBuilder<BaldaGameDbContext>()
                .UseInMemoryDatabase(databaseName: "GetPlayersOpponentWordsHandler_Handle_NormalData_RightOrder")
                .Options;

            var request = new GetPlayersOpponentWords()
            {
                GameId = 1,
                PlayerId = "1"
            };
            ...
            using (var context = new BaldaGameDbContext(options))
            {
                ...
                var service = new GetPlayersOpponentWordsHandler(context);
        ...
        [Test]
        public async Task GetPlayersOpponentWordsHandler_Handle_NormalData_Contains()
        {
            var options = new DbContextOptionsBuilder<BaldaGameDbContext>()
                .UseInMemoryDatabase(databaseName: "GetPlayersOpponentWordsHandler_Handle_NormalData_Contains")
                .Options;
        ...
        [Test]
        public async Task GetPlayersOpponentWordsHandler_Handle_NoWords()
        {
            var options = new DbContextOptionsBuilder<BaldaGameDbContext>()
                .UseInMemoryDatabase(databaseName: "GetPlayersOpponentWordsHandler_Handle_NoWords")
                .Options;
