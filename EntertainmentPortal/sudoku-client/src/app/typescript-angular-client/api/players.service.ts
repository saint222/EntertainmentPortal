...
export class PlayersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public playersGetPlayerByUserId(id?: string, observe?: 'body', reportProgress?: boolean): Observable<Player>;
    public playersGetPlayerByUserId(id?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Player>>;
    public playersGetPlayerByUserId(id?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Player>>;
    public playersGetPlayerByUserId(id?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Player>(`${this.basePath}/api/player`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
